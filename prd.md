...
- [x] 9. Supabase 사용자 프로필 테이블 필드 확장
- [x] 10. 회원가입 시 추가 정보 저장 로직 구현

### Phase 3: 데이터 저장 기능 (1-2시간)
- [x] 11. 계산 데이터 Supabase 저장 기능 구현
- [x] 12. 명시적 액션 버튼 클릭 시 데이터 저장 로직 연동
  - '계산하기' 버튼 클릭 시 저장
  - '상세히' 버튼 클릭 시 저장
  - 'PDF 다운' 버튼 클릭 시 저장
  - '공유' 버튼 클릭 시 저장
...
- **완료된 작업**: 
  ...
  - ✅ Supabase 사용자 프로필 테이블 스키마 생성
  - ✅ 회원가입 시 추가 정보 저장 로직 구현
