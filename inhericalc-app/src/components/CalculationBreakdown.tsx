...
export default function CalculationBreakdown({ formData, calculationResult }: CalculationBreakdownProps) {
  ...
  // 공제 계산
  const basicDeduction = formData.deductions.basic ? 100000000 : 0;
  const spouseDeduction = formData.deductions.spouse ? 500000000 : 0;
    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <div className="space-y-6">
        ...
        <div className="border-l-4 border-blue-500 pl-4">
          <h4 className="font-medium text-gray-700 mb-2">1단계: 총 재산가액 계산</h4>
        ...
        <div className="border-l-4 border-red-500 pl-4">
          <h4 className="font-medium text-gray-700 mb-2">2단계: 총 채무 계산</h4>
          <div className="bg-gray-50 p-3 rounded-lg space-y-2 text-sm">
            <div className="flex justify-between">
              <span>장례비:</span>
        ...
        <div className="border-l-4 border-green-500 pl-4">
          <h4 className="font-medium text-gray-700 mb-2">3단계: 순 재산가액 계산</h4>
        ...
        <div className="border-l-4 border-purple-500 pl-4">
          <h4 className="font-medium text-gray-700 mb-2">4단계: 공제 계산</h4>
          <div className="bg-gray-50 p-3 rounded-lg space-y-2 text-sm">
        ...
        <div className="border-l-4 border-orange-500 pl-4">
          <h4 className="font-medium text-gray-700 mb-2">5단계: 과세표준 계산</h4>
          <div className="bg-gray-50 p-3 rounded-lg text-sm">
            <div className="flex justify-between font-medium">
        ...
        <div className="border-l-4 border-indigo-500 pl-4">
          <h4 className="font-medium text-gray-700 mb-2">6단계: 세율 적용</h4>
          <div className="bg-gray-50 p-3 rounded-lg space-y-2 text-sm">
            <div className="flex justify-between">
              <span>과세표준:</span>
        ...
        <div className="border-l-4 border-pink-500 pl-4">
          <h4 className="font-medium text-gray-700 mb-2">7단계: 상속인별 세액</h4>
          <div className="bg-gray-50 p-3 rounded-lg text-sm">
            <div className="flex justify-between">
              <span>상속인 수:</span>
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        <h4 className="font-medium text-gray-700 mb-2">2024년 상속세율</h4>
